...
public class RestControllerV1 {
	...
	public ResponseEntity<?>  getLeaderBoard() {
		return new ResponseEntity(service.getLeaderBoard(1), HttpStatus.OK);
	}
	...
	public ResponseEntity<?>  getPreviousMatches() {
		return new ResponseEntity(service.getPreviousMatches(1), HttpStatus.OK);
	}
	...
	public ResponseEntity<?>  getUpcomingMatches() {
		return new ResponseEntity(service.getUpcomingMatches(1), HttpStatus.OK);
	}
	...
	public ResponseEntity<?>  createNewMatchResult(@RequestBody MatchScheduleAndResultDTO dto) throws Exception {
		service.createNewMatchResult(dto,1);
	...
	public ResponseEntity<?>  semifinals() {
		return new ResponseEntity(service.getSemiFinalsData(1), HttpStatus.OK);
	}
	...
	public ResponseEntity<?>  finals() {
		return new ResponseEntity(service.getFinalsData(1), HttpStatus.OK);
	}
